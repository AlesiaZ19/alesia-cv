const cvData = {
  en: {
    ...
    achievements: {
      ...
      items: [
        { number: "25%", label: "Time-to-Fill reduction" },
        { number: "120+", label: "Hires per year" },
        { number: "+20%", label: "Funnel conversion increase" },
        { number: "8", label: "Recruiters led" },
        { number: "95%", label: "Probation success" },
        { number: "2,000+", label: "Niche candidates" },
      ],
    },
    skills: {
      title: "Core Skills",
  ...
  ru: {
    ...
    achievements: {
      ...
      items: [
        { number: "25%", label: "Снижение срока закрытия вакансий" },
        { number: "120+", label: "Закрытых позиций в год" },
        { number: "+20%", label: "Рост конверсии воронки" },
        { number: "8", label: "Рекрутеров в команде" },
        { number: "95%", label: "Прохождение испытательного срока" },
        { number: "2,000+", label: "Нишевых кандидатов в базе" },
      ],
    },
    skills: {
      ...
      items: [
        {
          ...
          company: "Andersen",
          position:
            "Ведущий технический рекрутер / Руководитель группы подбора",
          paragraphs: [
